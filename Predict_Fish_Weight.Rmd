...
We fail to reject the null hypothesis because the p-value is high at 0.879. There is a difference between the best model which utilizes four variables and the best model that uses two variables.
...
We fail to reject the null hypothesis because the p-value is high at 0.9338.
